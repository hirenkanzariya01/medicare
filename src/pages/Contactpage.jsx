      ...
      <div className="left">
        ...
        <form >
          ...
          <div className="message">
            ...
            <textarea name="" id="" placeholder='Describe your concaran brtefly'></textarea>
          </div>
          <button>
            <FaTelegramPlane /> Send Via WahtsApp
          </button>
        </form>
      </div>
      <div className="right">
